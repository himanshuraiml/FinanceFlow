...
const BillForm: React.FC<BillFormProps> = ({
  ...
  const categories = getCategoriesByType('bill');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({
      ...
      frequency: formData.isRecurring ? formData.frequency as 'monthly' | 'quarterly' | 'yearly' : undefined
    });
          ...
          <div className="flex items-center space-x-3">
            <label className="flex items-center">
              <input
                ...
                className="rounded border-gray-400 dark:border-gray-600 text-cyan-600 focus:ring-cyan-500 bg-white dark:bg-gray-700"
              />
          ...
          <div className="flex items-center space-x-3">
            <label className="flex items-center">
              <input
                ...
                className="rounded border-gray-400 dark:border-gray-600 text-cyan-600 focus:ring-cyan-500 bg-white dark:bg-gray-700"
              />
              <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Recurring bill</span>
            </label>
          </div>
